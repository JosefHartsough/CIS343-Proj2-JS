...
class GameOfLife {
    ...
    /*****************************************************************
    Get grid generates the grid for Game Of Life
    @param x are rows, y are colums
    *****************************************************************/
    getGrid(x, y, data) { // get array of arrays
        ...
        for (let i = 0; i < this.rows; i++) {
            ...
            for (let j = 0; j < this.cols; j++) {
                this.grid[i][j] = data[offset++]; /** Copys the data to the grid */
            }
        }
    }
    /*****************************************************************
    Prints the grid basef on # of rows and columns
    *****************************************************************/
    printGrid() {
        for (let i = 0; i < this.rows; i++) {
            for (let j = 0; j < this.cols; j++) {
    ...
    /*****************************************************************
    Save gride saves the current gride to file
    The buffer is useed to handle the binary data from the input file
    (sample1.gol)
    @param Sample1.gol
    *****************************************************************/
    saveGrid(file) {
...
/*****************************************************************
Main function for Game of Life
*****************************************************************/
main();

function main() {
    /** program requires a .gol file name (sample1.gol or sample2.gol) */
    ...
    fs.open(process.argv[2], 'r', function (err, fd) {
	 ...
	 x is the height, y is the width.                         */
        let x = data[0];
        let y = data[1];
